...
<div class="col-lg-6">
<span class="logo">Check Your Knowledge</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<h2 align="center" style="font-family:'typo'; color:#000066">Contact Us</h2>
<div style="font-size:14px">
<?php if(@$_GET['q'])echo '<span style="font-size:18px;"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span>&nbsp;'.@$_GET['q'].'</span>';
else
{echo' 
We are always here to help. If you have any queries then, you can send us your query through following e-mail id:<br />
<div class="row">
<div class="col-md-1"></div>
<div class="col-md-10">
<a href="mailto:chiraggoel.53784@gmail.com" style="color:#000000">wearestrikers@gmail.com</a><br /><br />
</div><div class="col-md-1"></div></div>
<p>Or you can directly submit your query by filling the following enteries below :</p>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="#">Strikers</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9876543210</h4>
		<h4 style="font-family:'typo' ">wearestrikers@gmail.com</h4>
		</div></div>
		</p>
      </div>
